...
const Hero = () => {
  return (
    <section className="hero flex flex-col items-center w-full">
      <header className="flex gap-4 justify-center pt-16 pb-16">
        ...
        <div className="logo-text flex flex-col">
          <h1 className="text-5xl tracking-wide">Round Rock</h1>
      ...
      <div className="main-hero flex flex-col items-center justify-between py-2">
        ...
        <h2 className="text-8xl lorem-header py-3 font-thin">
          Lorem
        </h2>
        <h2 className="text-8xl font-extrabold">Lorem lorem</h2>
        <p className="text-center max-w-lg pt-5 pb-10 font-semibold text-lg">
