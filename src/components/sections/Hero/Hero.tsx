...
import SectionHeader from "../../../utils/SectionButton/SectionButton";
import "./Hero.css";
    ...
    <section className="hero flex flex-col items-center w-full">
      <header className="flex gap-4 justify-center py-16">
        <div className="logo w-18 pt-1">
          <img src={HeroLogo} alt="recycle truck logo" className="logo-image" />
        </div>
        <div className="logo-text flex flex-col ">
          <h1 className="text-5xl tracking-wider font-light">Round Rock</h1>
      ...
      <div className="main-hero flex flex-col items-center justify-between py-2">
        ...
        <h2 className="text-8xl lorem-header py-1 font-thin">Lorem</h2>
